...
<div class="modal fade" id="exportModal" tabindex="-1" role="dialog" aria-labelledby="exportModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Pilih tipe Exprt</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <a href="<?= base_url('hub/export') ?>" class="btn btn-success">Excel <i class="material-icons">cloud_download</i></a>
                <a href="<?= base_url('hub/export') ?>" class="btn btn-success">Csv <i class="material-icons">cloud_download</i></a>
            </div>
        </div>
    </div>
</div>
